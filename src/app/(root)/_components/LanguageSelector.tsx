  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="group relative flex items-center gap-2 sm:gap-3 px-2.5 sm:px-4 py-2.5 bg-[#1e1e2e]/80 rounded-lg transition-all
      ...
      >
        ...
        <div className="size-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform shrink-0">
          <Image
        ...
        <span className="hidden sm:block text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-56 sm:w-64 bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50"
          >
